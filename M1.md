...
Voy creando la carpeta `src` y el archivo `index.js`. También voy intalando algunas dependencias:
...
Creo una carpeta `data` y `routes` dentro de `src` para ir extructurando.
